...
public class GeRenKaiHuInsertServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		double PERPROP=Double.parseDouble(request.getParameter("PERPROP"));//个人比例
		String NAME=request.getParameter("NAME");//姓名
		String KIND=request.getParameter("KIND");//证件类型
		String NUMBER=request.getParameter("NUMBER");//证件号码
		String BASENUMBER=request.getParameter("BASENUMBER");//缓存基数
