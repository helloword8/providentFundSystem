...
public class gerendeleteservlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(d.findById(a)!=null){
			...
			response.sendRedirect("geren_uptate/deletesuccess.jsp");
		}
		else{
			response.sendRedirect("geren_uptate/gerendelete_default.jsp");	
		}	
	}
